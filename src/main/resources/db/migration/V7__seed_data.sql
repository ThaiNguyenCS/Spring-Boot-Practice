...
INSERT INTO users (email, password_hash, full_name, phone, role, status) VALUES
    ('admin@shop.com', '$2a$10$hashedpassword_admin', 'Admin User', '0901234567', 'ADMIN', 'ACTIVE'),
    ('alice@email.com', '$2a$10$hashedpassword_alice', 'Alice Nguyen', '0912345678', 'CUSTOMER', 'ACTIVE'),
    ('bob@email.com', '$2a$10$hashedpassword_bob', 'Bob Tran', '0923456789', 'CUSTOMER', 'ACTIVE'),
    ('carol@email.com', '$2a$10$hashedpassword_carol', 'Carol Le', '0934567890', 'CUSTOMER', 'ACTIVE'),
    ('staff1@shop.com', '$2a$10$hashedpassword_staff', 'Warehouse Staff 1', '0945678901', 'STAFF', 'ACTIVE');
